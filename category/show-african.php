...
function search_prod() {
    ...
    $check = "SELECT * FROM `product` WHERE `category` = 'African Kitchen' LIMIT $startFrom, $recordsPerPage";
    ...
    if($check_result) {
        ...
        // Pagination links
        $sql = "SELECT COUNT(*) AS total FROM `product` WHERE `category` = 'African Kitchen'";
